  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto h-full flex flex-col">
       <div>
           ...
           <p className="text-slate-500">Customize looks and add compliance details.</p>
       </div>
                             ...
                             <div className="grid grid-cols-3 gap-2">
                                {themes.map(t => (
                                    <button
                                        key={t.id}
                                        onClick={() => {
                                            dispatch({ type: 'UPDATE_BRANDING', payload: { theme: t.id as any, primaryColor: t.id === 'corporate' ? '#0f172a' : t.color } });
                                        }}
                                        className={cn(
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <input 
                                        ...
                                        onChange={(e) => dispatch({ type: 'UPDATE_BRANDING', payload: { primaryColor: e.target.value } })}
                                    />
                                    <span className="text-sm font-mono text-slate-500">{state.branding.primaryColor}</span>
                                </div>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-slate-700 mb-1 block">Button Color</label>
                                <div className="flex items-center gap-2">
                                    <input 
                                        type="color" 
                                        className="w-10 h-10 rounded cursor-pointer border-0 p-0"
                                        value={state.branding.buttonColor}
                                        onChange={(e) => dispatch({ type: 'UPDATE_BRANDING', payload: { buttonColor: e.target.value } })}
                                    />
                                    <span className="text-sm font-mono text-slate-500">{state.branding.buttonColor}</span>
                                </div>
                            </div>
                        </div>
                    </CardContent>
                        ...
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input 
                                    ...
                                    onChange={(e) => dispatch({ type: 'UPDATE_FOOTER', payload: { enabled: e.target.checked } })}
                                />
                        ...
                        {state.footer.enabled && (
                            <div className="space-y-3 animate-in fade-in slide-in-from-top-2 duration-200">
                                <Input 
                                    ...
                                    onChange={(e) => dispatch({ type: 'UPDATE_FOOTER', payload: { companyName: e.target.value } })}
                                />
                                <Input 
                                    label="Physical Address" 
                                    placeholder="123 Business St, City, Country"
                                    value={state.footer.address}
                                    onChange={(e) => dispatch({ type: 'UPDATE_FOOTER', payload: { address: e.target.value } })}
                                />
                                <div className="grid grid-cols-2 gap-3">
                                     <Input 
                                        ...
                                        onChange={(e) => dispatch({ type: 'UPDATE_FOOTER', payload: { supportEmail: e.target.value } })}
                                    />
                                     <Input 
                                        label="Website" 
                                        placeholder="www.example.com"
                                        value={state.footer.website}
                                        onChange={(e) => dispatch({ type: 'UPDATE_FOOTER', payload: { website: e.target.value } })}
                                    />
                                </div>
                            </div>
                        )}
           ...
           <div className="hidden lg:block bg-slate-200 rounded-xl overflow-hidden border-4 border-slate-300 shadow-inner relative">
                ...
                <div className="p-8 mt-8 h-full bg-white overflow-y-auto">
                    ...
                    <div style={{ fontFamily: 'sans-serif', maxWidth: '600px', margin: '0 auto' }}>
                        ...
                        <div className="mb-6 pb-6 border-b" style={{ borderColor: state.branding.primaryColor }}>
                        ...
                        {/* Button Placeholder */}
                         <div className="mb-8 text-center">
                            <span 
                                ...
                                className="inline-block px-6 py-3 rounded text-white font-medium text-sm"
                            >
                                Call to Action
                            </span>
                        </div>
                        ...
                        {state.footer.enabled && (
                            <div className="mt-8 pt-8 border-t border-slate-100 text-center text-xs text-slate-500">
                                <p className="font-bold text-slate-700">{state.footer.companyName || 'Company Name'}</p>
                                <p className="mt-1">{state.footer.address || 'Address Line'}</p>
