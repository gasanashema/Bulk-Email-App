    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      <div>
        ...
        <p className="text-slate-500">
          Create a professional signature to append to your emails.
        </p>
      </div>
          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewSig({ ...newSig, fullName: e.target.value })
                }
              />
              <Input
                label="Job Title"
                ...
                onChange={(e) =>
                  setNewSig({ ...newSig, jobTitle: e.target.value })
                }
              />
              <Input
                label="Company"
                ...
                onChange={(e) =>
                  setNewSig({ ...newSig, companyName: e.target.value })
                }
              />
              <Input
                label="Email"
                ...
                value={newSig.email}
                onChange={(e) =>
                  setNewSig({ ...newSig, email: e.target.value })
                }
              />
              <Input
                label="Phone"
                ...
                value={newSig.phone}
                onChange={(e) =>
                  setNewSig({ ...newSig, phone: e.target.value })
                }
              />
            </div>

            <div className="pt-4 flex justify-end">
              <Button onClick={handleCreate} disabled={!newSig.fullName}>
                Save Signature
              </Button>
            </div>
          </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {state.signatures.map((sig) => (
            <div
              key={sig.id}
              onClick={() =>
                dispatch({ type: "SELECT_SIGNATURE", payload: sig.id })
              }
              className={cn(
            ...
            >
              ...
              <div className="flex-1 space-y-1 text-sm text-slate-500 border-t pt-3 mt-1">
                ...
                {sig.jobTitle && (
                  <p>
                    {sig.jobTitle}
                    {sig.companyName && ` @ ${sig.companyName}`}
                  </p>
                )}
